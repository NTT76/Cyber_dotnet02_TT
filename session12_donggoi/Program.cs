internal class Program
{
    private static void Main(string[] args)
    {
        ...
        // để truy cập vào các thuộc tính private ta sử dụng các phương thức getter và setter
        #region 
        // tạp đối tượng person
        // dùng try.. catch để bắt lỗi nếu lỗi xảy ra
        try
        {
            Person person = new Person();
            // person.name = "John"; lỗi vì name là private
            person.Name = "John"; //đi qua setter của Name
            Console.WriteLine(person.Name); //đi qua getter của Name

            // person.Name = "A"; //vì tên không hợp lệ
            Console.WriteLine("===============");
        ...
        while (isRunning)
        {
            ...
            switch (choice)
            {
                case 1: vehicleManager.AddCar(); break;
                case 2: vehicleManager.displayAllVehicle(); break;
